...
public class TariffPage {
    ...
    //    int dtime =  random.nextInt(50);
//    public String deliTime = String.valueOf(dtime);
    ...
    public void addTariff(){
        ...
        deliveryCost.sendKeys(delCost);
        availabilityOfCard.click();
        geographicCoordinates.sendKeys(geoCor);
        additionalInfo.sendKeys(addiInfo);
        createButton.click();
        tariffList.click();
    }
    ...
    public void deleteTariff(){
        tariffsButton.click();
        tariffList.click();
        String tarifToDelete = nameOfTariff.getText();
